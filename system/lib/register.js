 ...
 * GET db
**/
const _registered = JSON.parse(fs.readFileSync('./system/sock/database/registered.json'))
...
const addRegisteredUser = (userid, name, age, time, serials) => {
    ...
    fs.writeFileSync('./system/sock/database/registered.json', JSON.stringify(_registered))
}
